			...
			<div className="grid grid-cols-1 md:grid-cols-2">
				...
				<div className="p-8">
					<p className="mt-2 text-justify w-auto">
						...
						sparked in 2022 when I started <span className="text-red">Springboard's</span> coding bootcamp.
						Turns out that building websites was my ideal way of combining my intellectual and artistic
						interests. I'm currently based in <span className="text-red">Pacific Grove, CA</span>, and
